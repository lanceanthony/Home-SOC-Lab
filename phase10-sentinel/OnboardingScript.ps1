...
try {
    ...
    $env:SUBSCRIPTION_ID = "ae83b40b-84da-43c9-81c4-390a49e8098a";
    $env:RESOURCE_GROUP = "rg-homesoclab";
    $env:TENANT_ID = "b8bdecc9-c8ce-492e-b391-ccfb1c4ae4b9";
    $env:LOCATION = "eastus";
    $env:AUTH_TYPE = "token";
    $env:CORRELATION_ID = "b8a11d18-faee-4ff7-bdde-bd8907452abb";
